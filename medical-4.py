...
"""
Medical Demo 4 from https://lorensen.github.io/VTKExamples/site/Python/Medical/MedicalDemo4/
"""
...
def main():
    ...
    render_interator = vtk.vtkRenderWindowInteractor()
    render_interator.SetRenderWindow(render_window)
